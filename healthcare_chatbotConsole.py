...
def username_verify():
    ...
    user_not_found.delete(0,END)

    user_not_found.__kwdefaults__()
    quit()
...
def main_account_screen(frmmain):
    main_account_screen=frmmain
    
    main_account_screen.geometry("300x250")
    main_account_screen.title("Account Login")
    Label(main_account_screen,text="Select Your Choice", bg="blue", width="300", height="2", font=("Calibri", 13)).pack()
    Label(main_account_screen,text="").pack()
    Button(main_account_screen,text="Login", height="2", width="30", command=login).pack()
    Label(main_account_screen,text="").pack()
    Button(main_account_screen,text="").pack()
    Button(main_account_screen,text="Register", height="2", width="30", command=register).pack()
